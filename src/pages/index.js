                        ...
                        <Carousel showThumbs={false} infiniteLoop={true} showStatus={false}>
                            <div className="carousel-slide">
                                <a href="/category/beauty-and-cosmetics">
                                    <img src="/images/slider-1.png"  blurDataURL={'/images/slider-1.png'}  placeholder="blur" priority={true} quality={50} width={0}
                                        height={0}
                                        sizes="100vw"
                            ...
                            <div className="carousel-slide">
                                <a href="/category/tour-and-travel">
                                    <Image src="/images/travell-banner.png"  quality={50} width={0}
                                        height={0}
                                        sizes="100vw"
                                        style={{ width: '100%', height: 'auto' }} alt="" />
                                ...
                                <a href="/category/beauty-and-cosmetics">
                                    <Image src="/images/Skin-Care-banner.png"  quality={50} width={0}
                                        height={0}
                                        sizes="100vw"
                                        style={{ width: '100%', height: 'auto' }} alt="" />
                                         <span className="sliderName">Skin Care</span>
                                ...
                                <a href="/category/furniture" className="megaSale">
                                    <Image  src="/images/furniture-banner.png"  quality={50} width={0}
                                        height={0}
                                        sizes="100vw"
                                        style={{ width: '100%', height: 'auto' }} alt="" />
                                ...
                                <a href="/category/sportswear">
                                    <Image src="/images/sports-fitness-banner.png"  quality={50} width={0}
                                        height={0}
                                        sizes="100vw"
                                        style={{ width: '100%', height: 'auto' }} alt="" />
